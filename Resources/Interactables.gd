...
@export_enum("Damage", "Healing", "Defensive", "Hazard", "Status", "Movement", "Creation", "Instant Effect") var type : String = "Damage"
...
func get_relevant_tiles(_aStart : Vector2i, _pieceType : int):
	pass
